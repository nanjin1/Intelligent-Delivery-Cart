...
#endif		   
	(void*)usmart_pid,"void usmart_pid(uint8_t motor,uint16_t aim,int mode)",
	(void*)Rudder_control,"Rudder_control(uint16_t aim,uint8_t id)",
//	  (void*)test,"void test(uint8_t data)",
